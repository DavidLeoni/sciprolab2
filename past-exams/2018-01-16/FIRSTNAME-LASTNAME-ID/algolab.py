...
def _get_generic_tree_def():
    ...
    if 'exercise3' in sys.modules: 
        return getattr(sys.modules['exercise3'], 'GenericTree')
    elif 'exercise3_solution' in sys.modules: 
        return getattr(sys.modules['exercise3_solution'], 'GenericTree')
    else:
...
def gt_children(t):
    """ Returns the children of provided GenericTree as a Python list
